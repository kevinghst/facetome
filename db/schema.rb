...
ActiveRecord::Schema.define(version: 20161229201250) do
  ...
  create_table "convos", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["names"], name: "index_convos_on_names", unique: true, using: :btree
  end
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["convo_id"], name: "index_messages_on_convo_id", using: :btree
    t.index ["sendee_id"], name: "index_messages_on_sendee_id", using: :btree
